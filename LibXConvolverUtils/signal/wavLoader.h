...
public:
	...
	static unsigned int openWavFile( std::string WavFile, WavStruct *WavHandle );
	...
	//						 ch2_0, ch2_1, ..., ch2_K,
	//						 chN_0, chN_1, ..., chN_K }
	static void reorderChannels(WavStruct *WavHandle);
	static bool checkWavStruct(WavStruct *WavHandle);

	// this method deletes the filter taps
	static void deleteWav(WavStruct *WavHandle);
};
