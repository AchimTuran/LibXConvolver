...
class LXC_CBenchmark_seperateChannels : public LXC_IBenchmark
{
public:
	LXC_CBenchmark_seperateChannels(uint InputFrameLength, 
									uint SampleFrequency, 
									LXC_OPTIMIZATION_MODULE OptModule, 
									uint MaxIterations=1,
									LXC_FFT_MODULE fftModule=LXC_fftModule_fftwf);

	virtual ~LXC_CBenchmark_seperateChannels();
