...
#include "LXC_CBenchmark_seperateChannels.h"
...
LXC_CBenchmark_seperateChannels::LXC_CBenchmark_seperateChannels(uint InputFrameLength, 
...
LXC_CBenchmark_seperateChannels::~LXC_CBenchmark_seperateChannels()
{
	if(m_InSignal[0])
	{
		delete [] m_InSignal[0];
...
double LXC_CBenchmark_seperateChannels::RunBenchmark()
{
